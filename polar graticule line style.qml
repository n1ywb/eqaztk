...
<qgis version="2.0.1-Dufour" minimumScale="0" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="precedence" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="major" label="major"/>
      <category symbol="1" value="minor" label="minor"/>
    </categories>
    <symbols>
  ...
  <displayfield>precedence</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="precedence"/>
    <edittype labelontop="0" editable="1" type="0" name="theta"/>
  </edittypes>
  <editform></editform>
